...
import { doc, getDoc, collection, getDocs, addDoc, updateDoc, arrayUnion, arrayRemove, setDoc, serverTimestamp, query, where, limit } from 'firebase/firestore';
...
const ProductDetails: React.FC = () => {
  ...
  const fetchSimilarProducts = async (currentProduct: Ad) => {
    try {
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-2xl font-bold text-blue-500 mt-4">{product.price.toLocaleString()} Frw</p>
          </motion.div>
          <motion.div
            initial={{ x: 50, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            ...
            <div className="flex space-x-2 mb-4">
              {isProductSold() ? (
                ...
                <button
                  ...
                  className="bg-blue-500 text-white px-4 py-2 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors flex-grow disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isOfferLoading ? (
              ...
              <button
                ...
                className={`p-2 rounded-lg border ${
                  isSaved ? 'bg-blue-100 text-blue-500 border-blue-500' : 'bg-white text-gray-500 border-gray-300'
              ...
              {similarProducts.map((product) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-blue-500 font-bold text-sm">{product.price.toLocaleString()} Frw</p>
